...
set :application_name, 'Salayo'
set :domain, 'salayo.com'
set :deploy_to, '/var/www/salayo.com'
set :repository, 'git@github.com:DaniG2k/salayo.git'
set :branch, 'master'
...
# Optional settings:
set :user, 'dani'          # Username in the server to SSH to.
